...
# TODO Vérifier la fonction de vérification sur d'autres distrib
...
# Stolen from http://fr.w3support.net/index.php?db=sf&id=3331
...
find / -ls > $OUTDIR/find.txt 2>/dev/null

echo "[+] getting os version"
(cat /usr/lib/os-release > $OUTDIR/os-release.txt) || (cat /etc/os-release > $OUTDIR/os-release.txt)
...
#TODO Vérifier que sa fonctionne sur chaque distrib
